...
function Cleansers() {
    ...
    useEffect(() => {
        getcategory("cleansers").then(res => {
        ...
        <>
            ...
            <header className="header-section mt-5 pt-4">
                <div className="headingText text-center py-5 my-5">
                    ...
                    <h1 className="fw-bold" style={{ fontSize: "4rem", letterSpacing: "0.3rem" }}>Cleansers</h1>
            ...
            <section className="controls py-3" style={{ backgroundColor: "rgb(230, 216, 228)" }}>
                <div className="container">
                    <Link to="#" data-bs-toggle="offcanvas" data-bs-target="#filterpage" aria-controls="filterpage" className="link-opacity-50-hover link-underline-opacity-0 fs-3 text-dark">
                            ...
                            <form>
                                ...
                                <div className="category">
                                    ...
                                    <div className="formgroup d-flex flex-column">
                                        <div>
                                            <input type="radio" name="alphabet" checked={filters.sortAlphabetically === "A-Z"} onChange={() => setFilters({ ...filters, sortAlphabetically: "A-Z" })} />
                                            <label className="form-label fs-5 mx-2">A to Z</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="alphabet" checked={filters.sortAlphabetically === "Z-A"} onChange={() => setFilters({ ...filters, sortAlphabetically: "Z-A" })} />
                                ...
                                <div className="category mt-5">
                                    ...
                                    <div className="formgroup d-flex flex-column">
                                        <div>
                                            <input type="radio" name="date" checked={filters.sortDate === "new-old"} onChange={() => setFilters({ ...filters, sortDate: "new-old" })} />
                                            <label className="form-label fs-5 mx-2">New to Old</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="date" checked={filters.sortDate === "old-new"} onChange={() => setFilters({ ...filters, sortDate: "old-new" })} />
                                ...
                                <div className="price mt-5">
                                    ...
                                    <div className="formgroup d-flex flex-column">
                                        <div>
                                            <input type="radio" name="price" checked={filters.sortPrice === "low-to-high"} onChange={() => setFilters({ ...filters, sortPrice: "low-to-high" })} />
                                            <label className="form-label fs-5 mx-2">Price (Low to High)</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="price" checked={filters.sortPrice === "high-to-low"} onChange={() => setFilters({ ...filters, sortPrice: "high-to-low" })} />

      ...
      <section className="mt-5">
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-secondary my-3 fs-3">
          ...
          <div className="categories row justify-content-center fs-3">
            {[
              ...
              <div
                key={index}
                className="col-lg-4 col-xl-3 col-md-9 col-sm-8 col-11 text-sm-center rounded-circle"
              >
                <figure>
                  <Link to={cat.link}>
                    <img
      ...
      >
        ...
        <div className="position-absolute w-50 fw-bold text-center Text">
          ...
          <p className="text-secondary my-5 fs-4 text-center w-75 mx-auto">
            Discover skincare that nourishes, restores, and enhances your
            natural beauty, leaving your skin healthy, radiant, and glowing
            every day{" "}
          </p>
          <div>
            <Link
              to="../Shopall"
              className="btn btn-large bg-dark border-0 text-white"
            >
              Shop Now
            </Link>
          </div>
      ...
      <section className="sales py-5">
        <div className="container text-center">
          ...
          <div className="row g-4 text-center">
            {sales.map((product) => (
              <div
                className="col-md-3 col-sm-9 text-sm-center"
                key={product.id}
              >
                      ...
                      <p>
                        {Array.from({ length: 5 }, (_, i) => (
                          <span
                            ...
                            style={{
                              color:
                                i < product.stars ? "#ffc107" : "#b4b4b4ff",
                            }}
                          >
                            &#9733;
                          </span>
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <p className="text-muted mb-4">
                At <span className="fw-semibold">Aurévia</span>, we believe that
                beauty starts with healthy skin. Our mission is to provide
                natural and dermatologically tested products that nourish your
                skin and bring out your natural glow.
              </p>
              <Link to="/about" className="btn btn-dark px-4 py-2">
                Learn More
              </Link>
            </div>
